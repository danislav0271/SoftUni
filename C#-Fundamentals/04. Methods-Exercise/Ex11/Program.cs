    ...
    internal class Program
    {
        ...
        static void PrintFirstElementsOfType(int[] numbers, int count, string oddOrEven)
        {
            ...
            for (int i = 0; i < numbers.Length; i++)
            {
                ...
                if (oddOrEven == "even" && currNum % 2 == 0 && firstElementsIndex < count)
                {
                    firstElements[firstElementsIndex] = currNum;
                    firstElementsIndex++;
                }
                else if (oddOrEven == "odd" && currNum % 2 != 0 && firstElementsIndex < count)
                {
                    firstElements[firstElementsIndex] = currNum;
                    firstElementsIndex++;
                }
        ...
        static void PrintLastElementsOfType(int[] numbers, int count, string oddOrEven)
        {
            ...
            for (int i = numbers.Length - 1; i >= 0; i--)
            {
                ...
                if (oddOrEven == "even" && currNum % 2 == 0 && lastElementsIndex < count)
                {
                    lastElements[lastElementsIndex] = currNum;
                    lastElementsIndex++;
                }
                else if (oddOrEven == "odd" && currNum % 2 != 0 && lastElementsIndex < count)
                {
                    lastElements[lastElementsIndex] = currNum;
                    lastElementsIndex++;
                }
